  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="mb-4">
        <i className="fa fa-info fa-lg text-grey-darker mr-1" /> {user.about}
        </div>
        ...
        <div className="mb-4"><i className="fa fa-calendar fa-lg text-grey-darker mr-1" /><a href="#" className="text-teal no-underline hover:underline">Joined {user.timestamp}</a></div>
