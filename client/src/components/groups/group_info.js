  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="mb-4"><i className="fa fa-user fa-lg text-grey-dark mr-1" /><a href="#" className="text-teal no-underline hover:underline">{members.length} Members</a></div>
        <div className="mb-4">
          {members.map((member)=>{
            return (
