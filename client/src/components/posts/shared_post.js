                        ...
                        <div className="flex justify-between">
                            <div>
                                <Link to={`/user/${this.props.post.ownerAddress}`} >
                                    <span className="font-bold"><a href="#" className="text-black" style={{ color: this.props.post.ownerColor }}>{this.props.post.ownerName}</a>
                                ...
                                <div className="flex border border-solid border-grey rounded">
                                    <div className="w-3/4 p-3">
                                        ...
                                        <Link to={`/user/${this.props.post.originalPost.ownerAddress}`} >
                                            <span className="font-bold mb-1" style={{ color: this.props.post.originalPost.ownerColor }}>
                                                {this.props.post.originalPost.ownerName}
                                                {this.props.post.originalPost.hasStar == 1 &&
                                                    <span className="rate text-grey-dark hover:no-underline text-teal">
                                                        <i className="fa fa-star fa-lg">
                                                        </i>
                                                    </span>
